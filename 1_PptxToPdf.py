...
if __name__ == "__main__":
    ...
    '''
    If desired, the program can convert multiple file formats to pdf.
    for this, remove the comments and process them, delete the codes 
    on lines 113, 144 and 119 so that other file types can be converted to pdf.
